    ...
    def _forward(self, t, xh, node_mask, edge_mask, context):
        ...
        if self.condition_time:
            if np.prod(t.size()) == 1:
                ...
                #print("\n\n\n\n h_time shape medium is ",h_time.shape)
                h_time = h_time.view(bs * n_nodes, 1)

                #print("\n\n\n\n h_time shape after is ",h_time.shape)
        ...
        if self.mode == 'egnn_dynamics':
            ...
            # #print("h shape is ", h.size())
            #print("h_final shape is ", h_final.size())
            # #print("x shape is ", x.size())
            # #print("x_final shape is ", x_final.size())
        ...
        #print("h_final0.1 shape is ", h_final.size())
        ...
        #print("h_final0.2 shape is ", h_final.size())
        if h_dims == 0:
            return vel
        else:
